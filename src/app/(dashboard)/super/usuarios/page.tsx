    ...
    <div className="space-y-8 pb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="border-b border-slate-100 pb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Todos os Tenants</span>
        </div>
        <h1 className="text-3xl font-[900] tracking-tight text-slate-900 leading-none mb-2">Usuarios Globais</h1>
              ...
              <div className="relative p-5 bg-white border border-slate-100 rounded-[28px] shadow-sm hover:shadow-md transition-all duration-500 hover:-translate-y-0.5">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex gap-4">
                    <div className="h-12 w-12 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400 font-black text-sm flex-shrink-0">
                      {initials}
                    </div>
                    <div className="min-w-0 space-y-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">{tenantNome}</span>
                      </div>
                    </div>
                  </div>
                  <Badge className={`${roleBadgeColor[u.role] || roleBadgeColor.proponente} border-none rounded-lg px-2 text-[8px] font-black uppercase tracking-widest py-0.5`}>
                    {roleLabels[u.role] || u.role}
                  </Badge>
                </div>

                <div className="mt-4 pt-3 border-t border-slate-50 flex items-center justify-between text-[9px] font-bold text-slate-300">
