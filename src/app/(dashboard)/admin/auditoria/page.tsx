  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="space-y-1">
        <h1 className="text-3xl font-[900] tracking-tight text-slate-900 leading-none flex items-center gap-3">
          <div className="h-2 w-8 bg-[var(--brand-primary)] rounded-full" />
          Log de Auditoria
        </h1>
        <p className="text-sm text-slate-500 font-medium italic">Registro de todas as acoes do sistema</p>
      </div>
            ...
            {typedLogs.map((log) => (
              <TableRow key={log.id} className="hover:bg-slate-50/50 transition-all duration-300 border-slate-50 group">
                ...
                <TableCell className="py-5 px-4">
                  <Badge className="border-none rounded-lg px-2 text-[10px] font-black uppercase tracking-widest py-1 bg-slate-100 text-slate-600">
                    {log.acao}
                  </Badge>
                </TableCell>
                <TableCell className="py-5 px-4">
                  <code className="text-[10px] font-black text-slate-900 bg-slate-50 px-2 py-1 rounded-md uppercase tracking-widest">
                    {log.tabela_afetada}
                  </code>
                </TableCell>
              ...
              <TableRow>
                <TableCell colSpan={5} className="h-64 text-center">
                  <div className="flex flex-col items-center justify-center space-y-4">
                    ...
                    <p className="text-slate-400 font-black text-[10px] uppercase tracking-widest">Nenhum registro de auditoria encontrado</p>
                  </div>
                </TableCell>
              </TableRow>
            )}
